...
//任务开始空闲一段时间
#define CHASSIS_TASK_INIT_TIME 300  //357
...
#define CHASSIS_VX_RC_SEN   0.006     //0.006f   //0.0005  //0.03飞坡测试
//rocker value (max 660) change to horizontal speed (m/s)
//遥控器左右摇杆（max 660）转化成车体左右速度（m/s）的比例
#define CHASSIS_VY_RC_SEN   0.006       //0.005f   //0.0005  //0.009
...
#define MOTOR_DISTANCE_TO_CENTER 0.26f //0.30f
...
//底盘3508最大can发送电流值
#define MAX_MOTOR_CAN_CURRENT 3000.0f
...
//底盘运动过程最大前进速度
#define NORMAL_MAX_CHASSIS_SPEED_X 4.0f  //2.0f  飞坡测试5.0f
...
//底盘旋转跟随PID
#define CHASSIS_FOLLOW_GIMBAL_PID_KP 3000.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_KI 0.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_KD 0.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_OUT 10000.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_IOUT 10000.0f
