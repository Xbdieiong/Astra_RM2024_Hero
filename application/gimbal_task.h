...
#define PITCH_SPEED_PID_KI        0.0f  //60
#define PITCH_SPEED_PID_KD        10.0f  //0
...
#define YAW_SPEED_PID_KD        10.0f  //0
...
#define PITCH_GYRO_ABSOLUTE_PID_KD 1.0f //0
...
#define YAW_GYRO_ABSOLUTE_PID_MAX_IOUT  0.6f

//pitch encode angle close-loop PID params, max out and max iout
//pitch 角度环 角度由编码器 PID参数以及 PID最大输出，积分输出
#define PITCH_ENCODE_RELATIVE_PID_KP 15.0f
#define PITCH_ENCODE_RELATIVE_PID_KI 0.00f
#define PITCH_ENCODE_RELATIVE_PID_KD 1.0f//0
#define PITCH_ENCODE_RELATIVE_PID_MAX_OUT 100000.0f//100000
#define PITCH_ENCODE_RELATIVE_PID_MAX_IOUT 0.8f

//yaw encode angle close-loop PID params, max out and max iout
//yaw 角度环 角度由编码器 PID参数以及 PID最大输出，积分输出
#define YAW_ENCODE_RELATIVE_PID_KP        10.0f
#define YAW_ENCODE_RELATIVE_PID_KI        0.0f
#define YAW_ENCODE_RELATIVE_PID_KD        2.0f//0
...
#define TURN_KEYBOARD KEY_PRESSED_OFFSET_X		//掉头180 按键
#define AUTOAIM_KEYBOARD KEY_PRESSED_OFFSET_Z         //自瞄
#define AUTOAIM_EXIT_KEYBOARD KEY_PRESSED_OFFSET_V    //退出自瞄
//turn speed
//掉头云台速度
#define TURN_SPEED    0.04f
#define ESCAPE_ANGLE_STEP 0.04f
//测试按键尚未使用
#define TEST_KEYBOARD KEY_PRESSED_OFFSET_R
//rocker value deadband
//遥控器输入死区，因为遥控器存在差异，摇杆在中间，其值不一定为零
#define RC_DEADBAND   3    //10
...
#define YAW_AUTOAIM_SEN    0.00005f
#define PITCH_AUTOAIM_SEN  0.00005f
...
//云台初始化回中值，允许的误差,并且在误差范围内停止一段时间以及最大时间5s后解除初始化状态，
#define GIMBAL_INIT_ANGLE_ERROR     0.08f //0.08f
#define GIMBAL_INIT_STOP_TIME       500
#define GIMBAL_INIT_TIME            2000
#define GIMBAL_CALI_REDUNDANT_ANGLE 0.08f
//云台初始化回中值的速度以及控制到的角度
#define GIMBAL_INIT_PITCH_SPEED     0.008f
#define GIMBAL_INIT_YAW_SPEED       0.006f
//0.025310684f
//0.205553427f
#define INIT_YAW_SET    0.00f
#define INIT_PITCH_SET  0.00f
...
typedef enum
{
	...
	GIMBAL_MOTOR_GYRO_XTL,//电机陀螺仪角度控制（小陀螺专属）
} gimbal_motor_mode_e;
...
typedef struct
{
    ...
    fp32 min_relative_angle; //rad
		fp32 autoaim_angle;     //rad
    fp32 last_autoaim_angle; //rad
